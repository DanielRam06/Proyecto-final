...
public class Canvas extends JPanel implements MouseListener, MouseMotionListener {
    ...
    private static final int ROWS = 25; // número de filas en la cuadrícula
    private static final int COLS = 25; // número de columnas en la cuadrícula
    private static final int CELL_SIZE = 20; // tamaño de cada celda en la cuadrícula
    ...
    public BufferedImage getImage() {
        return img; // Devuelve la imagen (BufferedImage) actualmente en uso
    }
    ...
    public void clear() {
        ...
        g2d.fillRect(0, 0, getWidth(), getHeight()); // Rellena el rectángulo que representa el área de dibujo con el color de fondo
